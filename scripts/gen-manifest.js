...
function sha256(file) {
  ...
  // Port de friendly-123 (2026-09-24): GitHub Pages sirve el blob de Git (LF).
  // En Windows, core.autocrlf deja CRLF en el checkout: el hash debe ser el
  // publicado. Nunca convertir PNG ni otros binarios.
