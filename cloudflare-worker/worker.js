...
async function recoveryKey(env) {
  ...
  return crypto.subtle.importKey("raw", recoveryEncoder.encode("consultorio-recovery-v1:" + env.MASTER_KEY),
...
export default {
  async fetch(req, env) {
    ...
    // Recuperación con permiso firmado de 5 min (JFC 2026-09-22, portado de friendly v341).
