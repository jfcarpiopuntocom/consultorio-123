# modus-operandi — Constitución de trabajo con JFC (consultorio-123)

> **OJO — consultorio-123 es app DISTINTA (JFC).** Su centro es lo CONTABLE y
> financiero: abonos, pagos, cuentas por cobrar de pacientes, control y
> visualización financiera fácil. La unidad básica es el PACIENTE (no la percha).
> **PIN = 4 dígitos POR DISEÑO** (no "corregir" a 3). NO portar perchas, variantes,
> comisiones a asociados, eventos ni reposición de stock — un consultorio no tiene
> nada de eso. Las reglas de POSTURA de este archivo aplican igual; las de
> mercado/producto se adaptan a este sector.
