...
const CACHE = "c123-shell-v57"; // bumped 2026-09-09: badge "beta version" en la pagina del PIN; la version real se controla por el entero del shell (c123-shell-vNN) // bumped 2026-08-27: port sync/team — failsafes (dedup 2000, cola 1000, LOG_TOPE 1000) + roster LWW con tombstones y PIN 4 dígitos
const SHELL = [
  "./",
  "./index.html",
  "./aislamiento.js",
