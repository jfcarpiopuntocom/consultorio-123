/*!
 * identity-context.js — Consultorio-123 (nuevo, 2026-07-23)
 *
 ...
 *
 *   - localStorage["c123_owned"]  → { instanceId, licenseCode, licenseEstado }
...
(function (global) {
  ...
  function construir() {
    ...
    return {
      ...
      // porque en Consultorio-123 una licencia = un negocio.
