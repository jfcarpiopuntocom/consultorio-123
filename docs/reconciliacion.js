...
(function (global) {
  ...
  // FIX (JFC 2026-08-20): decia "amg_archivo_db" -- literal compartido sin
  // querer por las 3 apps (mismo bug de clase que hechos.js/idb-archivo.js/
  // idb-fotos.js, encontrado en la misma auditoria). Esta base guarda las
  // copias de restauracion ("archivo antes de fusionar") -- justo el tipo de
  // dato que JFC dijo que nunca puede perderse. Rename CON migracion, nunca
  // se borra la base vieja.
  var DB_NAME = "c123_archivo_db";
  var DB_NAME_VIEJA = "amg_archivo_db";
  var MIGRACION_KEY = "c123_reconciliacion_migrado_v1";
  var DB_VERSION = 1;
  var STORE = "copias";
