// estado-idb.js — consultorio-123 · Espejo del estado del negocio en IndexedDB
// ============================================================================
// BUG QUE ARREGLA (JFC 2026-08-17, encontrado en amigable-123 y portado aqui
// porque la causa es identica: mismo origen, mismo techo de localStorage).
// AQUI IMPORTA MAS QUE EN LAS HERMANAS: lo que se pierde no es stock de una
// tienda, son abonos, pagos y cuentas por cobrar de pacientes.
...
(function () {
  ...
  var DB_NAME = "c123_estado";      // aislamiento.js le pone el namespace solo
  var STORE = "estado";
  var CLAVE = "actual";
